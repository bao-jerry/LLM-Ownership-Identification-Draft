...
## Current status:
This is a rough draft of a paper under active development. The core theoretical results of this paper are stable and complete, but the presentation will change.
