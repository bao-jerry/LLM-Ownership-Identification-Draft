...
## Current status
This is a rough draft of a paper undergoing active modifications. The core theoretical results of this paper are stable and complete, but expect significant changes to presentation.
